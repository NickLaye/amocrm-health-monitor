...
echo "2. Run 'npm run dev' (backend) и 'cd client && npm run dev' (frontend на http://localhost:5173)"
echo "3. Use 'cd client && npm run preview' для smoke-теста собранного dist"
echo "4. Or run 'npm start' for production mode"
echo ""
